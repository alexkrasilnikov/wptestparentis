			...
			if ( tutor_utils()->is_course_fully_booked( null ) ) {
				...
				?>
					<div class="tutor-course-single-pricing">
						<span class="tutor-fs-4 tutor-fw-bold tutor-color-black" style="display:none">
					...
					<div class="tutor-fs-7 tutor-color-muted tutor-mt-20 tutor-text-center" style="display:none">
